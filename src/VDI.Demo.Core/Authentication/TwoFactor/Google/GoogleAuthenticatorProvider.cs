...
namespace VDI.Demo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : DemoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("VDI.Demo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);

...
using VDI.Demo.Authorization.Users.Profile.Cache;
using VDI.Demo.Authorization.Users.Profile.Dto;
using VDI.Demo.Friendships;
using VDI.Demo.Identity;
using VDI.Demo.Security;
using VDI.Demo.Storage;
using VDI.Demo.Timing;

namespace VDI.Demo.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : DemoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("VDI.Demo",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("VDI.Demo",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }

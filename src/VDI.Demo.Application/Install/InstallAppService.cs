...
using VDI.Demo.Install.Dto;
using VDI.Demo.Migrations.Seed;
using VDI.Demo.Migrations.Seed.Host;
using Newtonsoft.Json;
using Newtonsoft.Json.Linq;

namespace VDI.Demo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : DemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<DemoDbContext> _migrator;

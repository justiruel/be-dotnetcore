...
using VDI.Demo.DemoUiComponents.Dto;

namespace VDI.Demo.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : DemoAppServiceBase, IDemoUiComponentsAppService
    {

...
namespace VDI.Demo.Web.Public.Startup
{
    ...
    public class DemoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public DemoWebFrontEndModule(IHostingEnvironment env, DemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(DemoWebFrontEndModule).GetAssembly());
        }
    }
}

...
using VDI.Demo.Url;
using VDI.Demo.Web.Public.Startup;
using VDI.Demo.Web.Session;

namespace VDI.Demo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : DemoViewComponent
    {

...
using VDI.Demo.Tests.TestDatas;
...
namespace VDI.Demo.Tests
{
    ...
    /// Provides methods to easily work with <see cref="DemoDbContext"/>.
    /// </summary>
    public abstract class AppTestBase : AbpIntegratedTestBase<DemoTestModule>
    {
